...
Sprachen, zunächst für die kurzen Laute: a) gr. α, \glsxtrshort{sanskrit} a, lat. u. s. w. a,
καλ-ός, \glsxtrshort{sanskrit} kalj-as (gesund), δάκρυ, l. lacruma, goth. tagr, δάκ-νω, \glsxtrshort{sanskrit}
da[cnull ]-āmi, goth. tah-ja (zerreisse), καν-αχέω, rausche, \glsxtrshort{sanskrit} ka[ndot ]-kani,
Glocke, l. can-o; — b) gr. o, \glsxtrshort{sanskrit} a (ā), lat. o (e), deutsch meist a: γόνυ, \glsxtrshort{sanskrit}
ǵānu, l. gĕnu, ὄψ (F όψ), l. vōx, \glsxtrshort{sanskrit} vā[kacute], δόμος, l. domus, \glsxtrshort{sanskrit} damas,
ὀκτώ, \glsxtrshort{sanskrit} ash[tnull ]āu, goth. ahtau, d. acht, ὄϊς (ὄϝις), \glsxtrshort{sanskrit} avis, l. ovis,
althochd. auwi Schäfchen; c) gr. ε, \glsxtrshort{sanskrit} a, lat. u. s. w. e (i): ἕρπ-ω. l.
serp-o, \glsxtrshort{sanskrit} sarp-āmi, ἑπτά, l. septem, \glsxtrshort{sanskrit} saptan, γένος, l. genus, \glsxtrshort{sanskrit} ǵanus,
μένος, \glsxtrshort{sanskrit} mánas, Gen. μένους (st. μένες-ος), \glsxtrshort{sanskrit} mánas-as, ἔδ-ω, l. edo, \glsxtrshort{sanskrit}
ad-mi, ἐς-τί, l. est, \glsxtrshort{sanskrit} ás-ti, φέρ-ω, l. fer-o, \glsxtrshort{sanskrit} bhár-āmi, ἔ-φερ-ον, \glsxtrshort{sanskrit}
...
vgl. \glsxtrshort{sanskrit} á-bhar-am u. ἔ-φερ-ον, \glsxtrshort{sanskrit} á-labh-am u. ἔ-λαβ-ον, a-bhar-āmahi u.
...
vgl. \glsxtrshort{sanskrit} Nom. u. Akk. Pl. pádas, Gen. S. padás u. πόδες, πόδας, ποδός, avahata =
...
Laute: ᾶ, η, ω gespalten. Z. B. δᾶήρ, \glsxtrshort{sanskrit} dēvṛ Nom. dēvā (d. i. daivā), l.
lēvir, στα- στη-, \glsxtrshort{sanskrit} sthâ, l. stā-re, ἡμι-, \glsxtrshort{sanskrit} sāmi, l. sēmi, althochd. sāmi-,
halb, δῶρον, \glsxtrshort{sanskrit} dānam, l. dōnum, γι-γνώ-σκω, \glsxtrshort{sanskrit} ǵānā-mi, l. (g)nōsco, ὠκύς,
\glsxtrshort{sanskrit} ā[cnull ]us, lat. Komp. ōcior. Über die Dialekte s. § 26. Auch diesen
...
ist im ganzen selten und tritt fast nur vor zwei Konsonanten ein,56) z. B. \glsxtrshort{sanskrit}
ē-dhi st. as-dhi [root ] as, ἴς-θι [root ] ἐς (esse); \glsxtrshort{sanskrit} hjas, χθές, χθιζός;
\glsxtrshort{sanskrit} a<*>va, l. equus, gr. ἵππος. Die Schwächung eines ursprünglichen A-Vokales,
nämlich des ο, in υ ist gleichfalls selten, z. B. νύξ, \glsxtrshort{sanskrit} naktam, l. nox, ξύν,
l. com, cum, ὄ-νυξ, \glsxtrshort{sanskrit} nakhas; hie und da ist auch das υ aus einem
ursprünglichen ϝ entstanden, vgl. das Suffix σύνη m. tvana, θύρα m. dvāra-m,
σῦριγξ m. √ svar, d. swirran, γυνή aus γFανή (\glsxtrshort{böot} βανά aus γFανά) m. goth.
...
[kacute] <*> des \Langlong{sanskrit} entspricht im Griechischen a) meistenteils κ, als:
κύ-ων, \glsxtrshort{sanskrit} [cnull ]van, N. çvā, l. can-is, δείκ-νυμι, \glsxtrshort{sanskrit} di[cnull ]-āmi, l.
in-dĭc-o; b) wo im \Langlong{sanskrit} [kacute] (k, <*>), im Lateinischen qu = kv, pflegt
...
\glsxtrshort{sanskrit} va[kacute]-mi, rede, va[kacute]-as, Wort, l. vōx, vōc-is, vŏc-are; s. indes
über den Wechsel des π u. κ in den Dialekten § 28, a); — c) im gleichen Falle
vor ε ι der Zahnlaut τ, als: τέ, \glsxtrshort{sanskrit} [kacute]a, l. que, τίς, τί u. τὶς, τὶ, \glsxtrshort{sanskrit}
na-kis, Niemand, l. quis, quid, πέντε, pañ[kacute]an, l. quinque, τέτταρες, \glsxtrshort{sanskrit}
...
k in γ erweicht, als: μείγνυμι, μίσγω, A. P. ἐμιγην, \glsxtrshort{sanskrit} mi[cnull ]rajāmi, l.
misc-eo, πήγ-νυμι, \glsxtrshort{sanskrit} pā[cnull ]-ajāmi, binde, l. pac-iscor, pāx, pāc-is,
...
durchweg als π, als: ἕρπω (st. σέρπω), \glsxtrshort{sanskrit} sarp-āmi, l. serpo, πόσις (st.
πότις), \glsxtrshort{sanskrit} patis, l. pot-is, pot-ens, πατήρ \glsxtrshort{sanskrit} pitā (St. pitar), l. pater.
Über die Dialekte s. § 32.

\paragraph{}Desgleichen entspricht dem t des Sanskr., Latein. u. s. w. fast
durchweg τ, als: τείνω ([root ] τεν) \glsxtrshort{sanskrit} tan-ō-mi, l. ten-do, στρών-νυμι, \glsxtrshort{sanskrit}
stṛ-ṇōmi, ἵ-στη-μι (st. σί-στη-μι), stelle, \glsxtrshort{sanskrit} ti-sh[tnull ]hā-mi, stehe, l.
...
entspricht dem g ǵ des \Langlong{sanskrit} a) gr. γ, als γένος, \glsxtrshort{sanskrit} gánus, l. genus, γεύω,
\glsxtrshort{sanskrit} ǵush-āmi, l. gusto; — b) es ist aus gv vielfach β hervorgegangen, als:
βαίνω, ἔβην, \glsxtrshort{sanskrit} ǵi-gā-mi, A. a-gām, lat. venio für gvenio; βαρύς, \glsxtrshort{sanskrit} gurus, l.
grav-is; βοῦς, \glsxtrshort{sanskrit} gāus, hier auch lat. bos; βρέφος (τό), \glsxtrshort{sanskrit} garbh-as (masc.);
βίος, βίοτος, \glsxtrshort{sanskrit} ǵîvas, ǵîvathas, Leben, lat. vîvus, lebendig, für gvivus; über
...
\paragraph{} Sanskr. lat. d = gr. δ, als: δί-δω-μι, \glsxtrshort{sanskrit} da-dā-mi, l. do,
δάμνημι, \glsxtrshort{sanskrit} dām-jāmi, l. domo, ἔδω (ἐσθίω), \glsxtrshort{sanskrit} admi, l. edo.
...
ἐ-λάχ-ιστος, \glsxtrshort{sanskrit} lagh-us (leicht), lagh-iš[tnull ]has, χοῖρος, Ferkel, \glsxtrshort{sanskrit}
ghṛshvis, Schwein; νέφος Wolke, \glsxtrshort{sanskrit} nabhas, Luft; φόβος, \glsxtrshort{sanskrit} bhaj-am, φρᾶτήρ,
\glsxtrshort{sanskrit} bhrātṛ Nom. bhrātā, l. frater; ἄνθος, Keim, Blume, \glsxtrshort{sanskrit} an-dhas, Kraut, Grün,
...
meistens g, als: χθές, \glsxtrshort{sanskrit} hjas, l. heri, χείρ, \glsxtrshort{sanskrit} har-aṇam (Hand), altlat. hir
b. Lucil., χαίρω, \glsxtrshort{sanskrit} harj-âmi (amo, desidero), ὀχέω (Fοχέω), \glsxtrshort{sanskrit} vah-āmi, l.
veho; ἔγχελυς, lat. anguilla, λείχω, \glsxtrshort{sanskrit} [root ] lih, l. lingo. Für φ hat das
Lateinische im Anlaut f, als φεύγω, fugio, im Inlaut b, als ἄμφω, ambo; für θ
anlautend ebenfalls f, als θυμός, \glsxtrshort{sanskrit} dhūmas (Rauch), lat. fūmus, inlautend
wieder die Media d, als μέσσος st. μέθjος, \glsxtrshort{sanskrit} madhjas, lat. medius, oder b, als
...
Et.\textsuperscript{5}, 554. Z. B. ἐρέσσειν, \glsxtrshort{sanskrit} ar-i-tras (Ruder), l. rēmus,
φέρῳ, \glsxtrshort{sanskrit} bharâmi, l. fero, goth. baira; — λύω, \glsxtrshort{sanskrit} lu-nāmi (seca, disseco), l.
re-luo, löse wieder ein, so-lvo (st. se-luo, solū-tus), goth. lau-sja, löse,
μέλᾶς, \glsxtrshort{sanskrit} malas, schmutzig, schwarz, l. mălus; — aber \glsxtrshort{sanskrit} r = griech. l z. B.
λευκός, weiss, λύχνος, Leuchte, l. luceo, \glsxtrshort{sanskrit} rō[kacute]-ē, leuchte, ru[kacute],
Glanz, πολύς, πλεῖον, l. plus, \glsxtrshort{sanskrit} purus, viel, κλύω, lat. cluo, \glsxtrshort{sanskrit} [root ]
[cnull ]ru, πίμπλημι, l. pleo, \glsxtrshort{sanskrit} piparmi; — ρ und λ schwanken im Griechischen
...
allgemeinen als ν wieder, so: ναυς, \glsxtrshort{sanskrit} nāus, l. navis, ἀνήρ, \glsxtrshort{sanskrit} naras (Mann,
Mensch), ἐννέα (ἐννέFα), \glsxtrshort{sanskrit} navan, l. novem, ὄνυξ, G. -χος, \glsxtrshort{sanskrit} nakhas, l.
...
Sprachen als μ erhalten, als: μή, \glsxtrshort{sanskrit} mā, μέσσος, μέσος, \glsxtrshort{sanskrit} madhjas, l. medius,
μήτηρ, dor. μάτηρ, \glsxtrshort{sanskrit} mātā (St. matar), l. mater, ἅμα, \glsxtrshort{sanskrit} samā, l. simul, ἐμέω
(Fεμέω), \glsxtrshort{sanskrit} vam-āmi, l. vomo. Im Inlaut ist es in wenigen Wörtern (vor j) in ν
...
Auslaut immer, als: τόν st. τόμ, \glsxtrshort{sanskrit} tam, ἔ-φερον, \glsxtrshort{sanskrit} á-bharam, l. ferebam,
ἀγρόν, \glsxtrshort{sanskrit} aǵram, l. agrum. Über das dor. νίν st. μίν s. § 29 a, über den
...
ist es in den Spiritus asper übergegangen, als: ἅμα, \glsxtrshort{sanskrit} samas (ähnlich), goth.
sama (derselbe), d. samt; ἥμι-συς, \glsxtrshort{sanskrit} sâmi-, l. sēmi-, ahd. sâmi-(halb); ὁδός
[root ] ἑδ, σεδ, \glsxtrshort{sanskrit} sād-ajâmi gehe hinzu; ἑζόμην ἵζω [root ] ἑδ, σεδ, \glsxtrshort{sanskrit}
sîdâmi, l. sedeo, d. sitzen; ὕπνος, \glsxtrshort{sanskrit} svapnas (also gr. entspr, mit sva
zunächst συ), l. somnus; ἅλλομαι, l. salio; ἅλς, \glsxtrshort{sanskrit} saras, l. sal, d. Salz;
ὕλη, l. silva; ὕραξ (υ), lat. sōrex (auch hier sva = συ); ὗς neben σῦς, l. sus,
d. Sau; ἕρπω, \glsxtrshort{sanskrit} sarpâmi, l. serpo; ἑπτά, \glsxtrshort{sanskrit} saptan, l. septem; ἕβδομος, \glsxtrshort{sanskrit}
saptamas, l. septimus; ἕπομαι, \glsxtrshort{sanskrit} sisa[kacute]mi, l. sequor; ἵστημι, l. sisto;
desgleichen zum Teil ς mit folgendem ϝ: ἱδρώς, \glsxtrshort{sanskrit} svidâmi, schwitze, l. sūdor
(aus svoidōs od. sveidōs, L. Meyer), d. Schweiss; ἁνδάνω, ἥδομαι, \glsxtrshort{sanskrit} svad-âmi,
koste, gefalle, Med. svâdê, gefalle, ἡδύς, \glsxtrshort{sanskrit} svâdus, l. suāvis a. svadv-is;
οὗ, οἷ, ἕ (σϝοῦ, σϝοῖ, σϝέ), ὅς, ἑός (σϝός, σεϝός), \glsxtrshort{sanskrit} sva- (selbst), svas
(eigen), l. sui, sibi, se, suus (aus sevos sovos), ἑκυρός, \glsxtrshort{sanskrit} çvaçuras, l.
sŏcer a. svocer, goth. svaihra; ἕξ dor. ϝέξ, \glsxtrshort{sanskrit} [sbreve]a[sbreve], sex, sechs;
ἕκτος, \glsxtrshort{sanskrit} šaš[tnull ]has, l. sextus. In anderen Fällen ist indes von σϝ das ς
...
σκεδῶ § 228; Deklin. Gen. ἀγροῖο st. ἀγρόςjο, \glsxtrshort{sanskrit} aǵrasja; μῦς μυός. l. mus,
muris st. musis; γένος, G. γένεος, \glsxtrshort{sanskrit} manas, G. manasas, l. generis, st.
genesis; ἀληθής, ἀληθέος, dazu ἀλήθεια aus ἀληθεςjα; ferner (ς) ἕρπω, Impf.
ἔἑρπον, εἷρπον, (ς) ἕπομαι, Impf. ἐἑπόμην, εἱπὀμην; ἦα, ἦ, \glsxtrshort{sanskrit} âsam, l. eram,
εἴην st. ἔςjην; ἠώς, ἕως, äol. αὔως, \glsxtrshort{sanskrit} ušas, l. aurora; ἰός Gift, l. virus,
ἔαρ Frühling, \glsxtrshort{sanskrit} vasantas; νυός Schwiegertochter, l. nurus, d. Schnur u. s. w.
...
goth. snaiv-s, a h d. sneo sniwit; νυός, \glsxtrshort{sanskrit} snušâ, ahd. snŭr, jetzt Schnur;
...
(aus ϝές-νυμι), \glsxtrshort{sanskrit} vas-man (Kleid), l. ves-tio, ἑκών, ἕκηλος, \glsxtrshort{sanskrit} va[cnull ]-mi
(will), ἑστία, l. Vesta, ἕρση (Tau), \glsxtrshort{sanskrit} varš-as (Regen), ἵστωρ, ἱστορία,
...
ἑκυρός, \glsxtrshort{sanskrit} [cnull ]va[cnull ]uras Kühners ausführl. Griech. Grammatik. I. T.
(st. svakuras), goth. svaihra, ἡδύς, \glsxtrshort{sanskrit} svâdus, l. suavis (schon Alkman 37
...
τέτορες, äol. πέσσυρες, hom. πίσυρες, ion. τέσσερες, vgl. \glsxtrshort{sanskrit} [kacute]atvâras,
...
οἶκος, \glsxtrshort{sanskrit} vê[kacute]as (Haus), l. vicus, goth. veihs (Dorf), εἴκω, weiche, ὄψ,
vox, ἔργον, Werk, ἐργάζομαι, wirke, ἔτος, \glsxtrshort{sanskrit} vatsas (Jahr), l. vetus, ῖτέα,
richtig εἰτέα, Weide, l. vitex, ἄστυ, \glsxtrshort{sanskrit} vâstu (Haus), l. Vesta, ἦρ, ἔαρ, vēr,
ἴον, viola, ἰός (Gift), \glsxtrshort{sanskrit} vish-as, l. virus, ἴς, vis, ἐμέω, \glsxtrshort{sanskrit} vam-âmi, l.
vomo, u. v. a.; vor ρ, als: ῥόδον st. ϝρόδον, ῥήγνυμι st. ϝρ.; hinter δ und ς
(δϝ, σϝ), als: δώδεκα neben δυώδεκα, δίς st. δϝίς, \glsxtrshort{sanskrit} dvis, l. bis, ἦδος, ἡδύς,
\glsxtrshort{sanskrit} svâdus, l. suavis, ἔθος, ἦθος, ἐθίζω [root ] σϝεθ, σάλος, Schwanken, ahd.
swellan, jetzt schwellen, σέλας, σελήνη, σείριος, \glsxtrshort{sanskrit} svar (Himmel), l. sôl,
...
αἰών, aevum, βοῦς, l. bôs, \glsxtrshort{sanskrit} gâus, βοός, bovis, \glsxtrshort{sanskrit} gav-as, δαήρ, \glsxtrshort{sanskrit} dêvâ (A.
...
ἄστυ, \glsxtrshort{sanskrit} [root ] vas, wohnen, vastu, Haus, \glsxtrshort{böot} Eigenn. Fαστίας u. s. w.,
...
εἴκοσι, \glsxtrshort{böot} ϝίκατι, lak. βείκατι Hesych., ϝείκατι, ϝίκατι tab. Heracl., \glsxtrshort{sanskrit} v<*>[cnull ]ati, l. viginti, καί in Compositis lang Il. β, 510. 748 u. s. w.; häufig ἐείκοσι (Cobet, Misc. cr. 379).
...
ἕκηλος, \glsxtrshort{sanskrit} [root ] va<*>, va[cnull ]-mi = volo, s. Curt., Et.\textsuperscript{5} 136: Hiat. im V. F. Il. ε, 759. ι, 376 u. s. w. (für ἕκ. auch εὔκηλος d. i. ἐϝ (έ) κηλος); ἕκητι, Hiat. Od. ο, 319. τ, 86. υ, 42 u. s. w., vgl. ἀέκητι; ἑκών, Hiat. ebenso im Kompos. ἀέκων, b. ἑκ. Od. π, 95. Il. ζ, 523 u. s. w. Vgl. ϝεκών lokr. Inschr. Dial.-Inschr. 1478, 12.
...
ἔργον s. ἔρδω. ἔργω, ἐέργω (woraus εἴργω), sondere ab, Pf. ἔεργμαι, \glsxtrshort{sanskrit} vṛ-n-aǵmi, l. urgeo, Hiat. am Ende des III. F. Il. λ, 437; Verlängerung auslautenden kurzen Vokals in d. II. Heb. Od. ξ, 411.
...
ἶσος (aus ϝίσϝος, wie die Gortyn. Tafeln bieten) und die Derivata, vgl. \glsxtrshort{sanskrit} vishu = aeque Curt., Et.\textsuperscript{5} 378, lang μετηύδα in d. IV. Senk. Il. ψ, 569, καμινοῖ in d. II. Od. ς, 27, βροτολοιγῷ Il. λ, 295. μ, 130. ν, 802 u. s. w. (Knoes II, 129 f.); aber οι kurz vor ἴση Il. λ, 705. Od. ι, 42, 549; Hiat. vor ἶσος im II. F. Il. λ, 336 u. sonst. Vgl. b. Hom. ἐΐση.

ἰτέη, richtig εἰτέη (γιτέα Hesych.), Weide, althochd. wîda, \glsxtrshort{sanskrit} vê-tasas, eine Rohrart, Curt.\textsuperscript{5} 389, l. vi-tex, vi-men, lang καί in d. III. Senk. Od. κ, 510; aber Il. φ, 350 πτελέαι τε καὶ ἰτέαι, wo Bekk. liest: πτελέαι καὶ ϝιτέαι; verwandt ἴτυς, äol. ϝίτυς (Meister, Dial. I, 105 f.), Il. δ, 486 ὄφρα ϝίτσν.
...
\paragraph{} Die Verwandlungen, welche das ursprüngliche j im Griechischen erfahren hat, sind folgende: a) j wird ι, dem es unter allen Vokalen am Meisten verwandt ist, wie ϝ u. υ § 16, 3, b (vgl. Ἀχαΐα, Αἴας, Μαῖα, Τροία mit Achaja, Ajax, Maja, Troja, sowie Gajus, Pompejus, Trajanus, Aquileja mit Γάϊος, Πομπήϊος, Τραϊανός, Ἀκυληΐα).107) Indes ist eben wegen der engen Berührung von i und j sehr schwer zu bestimmen, inwieweit in den einzelnen Fällen der Halbvokal oder der Vokal ursprünglich ist. Vgl. Gen. S. der II. Dekl. ο-ιο, \glsxtrshort{sanskrit} a-sja, als: ἀγροῖο, \glsxtrshort{sanskrit} aǵrasja, ἵπποιο, \glsxtrshort{sanskrit} a[cnull ]va-sja, ς fiel aus (§ 15, 1), j blieb als ι nach; ebenso in ἀλήθεια für ἀληθεςjα u. s. w. Ferner gehören hierher die Bildungssuffixe: ιος, ία, ιον, \glsxtrshort{sanskrit} jas, jā, jam, als: ἅγ-ιος, \glsxtrshort{sanskrit} jaǵ-jas (colendus), πάτρ-ιος, \glsxtrshort{sanskrit} pitr-jas, l. patr-ius, ἐλευθέριος, κύριος (thessal. κῦρρος nach § 21, 6), μέτριος (lesb. μέτερρος mit eingeschobenem ε, für μέτερjος),108) παράλιος, χρόνιος u. s. w.; Kompar. ίων, ιον, l. ior, ius, \glsxtrshort{sanskrit} ījān, als: ἡδ-ίων, \glsxtrshort{sanskrit} svād-ījāns, l. suav-ior, in anderen Fällen im Griechischen als jων behandelt: μᾶλλον f. μάλjον, ἥττων f. ἥκjων u. s. w.; Verbalbildungen, als: ἰδ-ί-ω (σϝιδ-ί-ω), \glsxtrshort{sanskrit} svidjā-mi, δαίω brenne, aus δάϝjω, ναίω aus νάςjω, Hom. lesb. τελείω aus τελέςjω, εἴην (d. i. ἐς-ίην, \glsxtrshort{sanskrit} (a)s-jām, l. (e)s-jem). b) j wird scheinbar zu ε, d. h. es entwickelt sich vor dem j ein ε, welches nach Ausfall desselben übrig bleibt: so in dem dor. Futurum auf -σέω, \glsxtrshort{sanskrit} sjâmi, welche Gleichstellung indes vielfach bestritten wird, in πόλεως (aus πόληος) πόλεος = πόλεjος, ion. u. s. w. πόλιος. c) anlautendes j wird ζ (= sd, mit weichem s oder franz. z), d. h. es entwickelt sich vor j eine palatale, dann dentale Media, und dies δj wurde dann wie sonstiges δj (s. § 21, 1) behandelt; vgl. das ital. già (spr. dscha) aus dià mit l. jam, giacere aus diacere mit l. jacere; z. B. ζεύγ-νυμι, \glsxtrshort{sanskrit} ju-naǵmi, l. ju-n-go, ζυγ-όν, l. jug-um, d. Joch, ζέω ([root ] ζες), siede, \glsxtrshort{sanskrit} [root ] jas, nir-jas, ausschwitzen, ahd. jes-an, nhd. gären, ζειά, Dinkel, Spelt, \glsxtrshort{sanskrit} java-s, Gerste, ζώννυμι, gürte (f. ζώς-νυμι), vgl. Zend jāstō, gegürtet; zweifelhaft ist derselbe Vorgang im Inlaut, wo ihn Curtius für die Verben auf άζω, ίζω annimmt, \glsxtrshort{sanskrit} ajāmi. 
...
{\small\noindent\subparagraph{} In Dialekten wie dem böotischen ist von dem aus
  ...
  \glsxtrshort{sanskrit} jas, jā, jad, ὡς, \glsxtrshort{sanskrit} jāt, ὑμᾶς, \glsxtrshort{sanskrit} jushmân, ἧπαρ, \glsxtrshort{sanskrit} jakrt, l. jecur,
  ἅγ-ιος, ἁγ-νός, ἅγ-ος, ἁγ-ίζω, \glsxtrshort{sanskrit} jaǵ-âmi (opfere, ehre), jaǵ-us (Gebet),
  ...
  [root ] ὑθ, \glsxtrshort{sanskrit} judh-mas, Kampf, Kämpfer. e) Spurlos verschwunden ist
...
\paragraph{} γ mit j wird gleichfalls ζ, indem γ vor
  j in δ übergeht; vgl. αζ-ομαι aus αγ-jομαι (\glsxtrshort{sanskrit} jaǵ-āmi, opfere, ehre) neben
...
\paragraph{} κ, χ mit j
  ...
  nach Wegfall des j τύπ-τ-ω, aus σκέπ-δj-ομαι, \glsxtrshort{sanskrit} pa[cnull ]j-âmi, l.
  ...
  \glsxtrshort{sanskrit} ak-sham, ak-shi, Auge, l. oculus; ὄσσα, ϝόσσα (ϝέπος, ϝόψ, ϝειπεῖν), vgl.
  \glsxtrshort{sanskrit} vi-va[kacute]-mi, rufe, va[kacute]-as, Wort, l. vox, G. vocis; φάσσα, vgl.
  φάψ, φαβ-ός, wilde Taube; πέσσω (πέπων, πέψω), \glsxtrshort{sanskrit} pa[kacute]-āmi, l. coqu-o,
  ἐνίσσω (ἐνιπή, ἠνίπαπε, ἐνένιπε); — νίζω, wasche, Fut. νίψω ([root ] νιβ,
  χέρνιψ, G. χέρνιβ-ος), vgl. \glsxtrshort{sanskrit} nê-nêǵ-mi, reinige; ion. u. Hom. λάζομαι,
  ...
  und dies dann in üblicher Weise umgewandelt: βαίνω [root ] gam \glsxtrshort{sanskrit}, χλαῖνα
...
449; st. ὅλος (\glsxtrshort{sanskrit} sarvas = omnis, altlat. sollus) οὖλος; οὖρος, Grenze, st.
...
\paragraph{} Aber auch in dem gemeingriechischen Gebrauche kommen einzelne Erscheinungen vor, welche den Schwestersprachen gegenüber als besondere Eigentümlichkeiten des Griechischen hervortreten. So z. B. hat jedes anlautende υ (= ü) den Asper, während das alte υ = ου u der Böotier nach allem Anschein den Lenis hatte, als: ὕδωρ, \glsxtrshort{böot} οὔδωρ, lokr. Inschr. ὐδρία, \glsxtrshort{sanskrit} ud-am, l. unda, ὑπέρ ὕπατος (\glsxtrshort{böot} Υπατόδωρος, Upatod. ohne H Dial.-Inschr. 1130), \glsxtrshort{sanskrit} upari; vgl. Thumb S. 41 f.; der Spir. scheint mit dem Übergange des u in ü angetreten zu sein.132) Fernere Unregelmässigkeiten: att. ἕως, ion. ἠώς, dor. ἀώς, äol. αὔως, \glsxtrshort{sanskrit} ušas, l. aurora (ausosa); ἡγεῖσθαι ἁγεῖσθαι neben ἄγειν; ἵππος neben tarent. ἴκκος (Et. M. p. 474, 12), \glsxtrshort{sanskrit} açvas, l. equus, daher λεύκιππος S. El. 706 (λεύχιππος überall nicht), Γλαύκιππος, \glsxtrshort{böot} Ἀντιππίδας und Ἄνθιππος u. s. w.;133) vgl. § 23, 3. 
